...
Pyth-MPG is a Python library for ...

PythMPG provides tools for:
- Analyzing ...
...
For more information on contributing to PythTB, see:
- [Contributing to `PythTB`](https://pythmpg.readthedocs.io/en/latest/development.html)
- [CONTRIBUTING.md](https://github.com/pythmpg/pythmpg/blob/dev/CONTRIBUTING.md)
- [PythTB Wiki](https://github.com/pythmpg/pythmpg/wiki)
